  ...
  return (
    <>
      ...
      <Box textAlign={"center"}>
        <Heading color="blue.200" fontSize="3xl">
          Our Mission:
        </Heading>
        <Text mx="130px" mt="11px" color="white" fontSize="lg">
          We would like to make opportunities accessible to everyone, including
          high school students, especially those who don't have the pre-existing
          resources necessary to find an internship.
        </Text>
      </Box>
    </>
  );
